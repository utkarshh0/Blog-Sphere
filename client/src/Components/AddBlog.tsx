    ...
    return (
        <>
            <div className="w-screen h-screen px-8 py-16 md:p-12 lg:p-16">
                <button onClick={() => onClick(false)} className="my-2 text-3xl hover:opacity-75 border-b rounded-lg">
                    <IoMdArrowBack />
                </button>
                <form onSubmit={handleSubmit} className="w-full h-full flex flex-col justify-between gap-4">
                    ...
                    <hr />
                    <button className="w-28 p-2 rounded-md bg-gray-400 cursor-pointer" type="submit">
                        Post
                    </button>
                </form>
            </div>
